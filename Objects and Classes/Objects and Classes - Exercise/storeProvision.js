function storeVision(firstArray,secondArray){
...
for (index=0; index<secondArray.length; index+=2){
...
storeVision(['Chips', '5', 'CocaCola', '9', 'Bananas','14', 'Pasta', '4', 'Beer', '2'],['Flour', '44', 'Oil', '12', 'Pasta', '7','Tomatoes', '70', 'Bananas', '30'])